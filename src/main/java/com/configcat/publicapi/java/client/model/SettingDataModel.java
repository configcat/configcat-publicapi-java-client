...
public class SettingDataModel {
  ...
  public SettingDataModel settingType(SettingTypeEnum settingType) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(settingId, key, name, hint, settingType, order, createdAt, creatorEmail, creatorFullName, isWatching);
  }
