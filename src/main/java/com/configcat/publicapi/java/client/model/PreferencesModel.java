...
public class PreferencesModel {
  ...
  public PreferencesModel keyGenerationMode(KeyGenerationModeEnum keyGenerationMode) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(reasonRequired, keyGenerationMode, showVariationId, reasonRequiredEnvironments, mandatorySettingHint);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PreferencesModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PreferencesModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
