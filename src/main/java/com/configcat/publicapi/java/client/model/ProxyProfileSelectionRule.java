...
public class ProxyProfileSelectionRule {
  ...
  public ProxyProfileSelectionRule() {
  }

  public ProxyProfileSelectionRule kind(@javax.annotation.Nonnull SelectionRuleKind kind) {
    this.kind = kind;
    return this;
  }
  ...
  public void setKind(@javax.annotation.Nonnull SelectionRuleKind kind) {
    this.kind = kind;
  }


  public ProxyProfileSelectionRule productIdFilter(@javax.annotation.Nullable UUID productIdFilter) {
  ...
  public ProxyProfileSelectionRule configIdFilter(@javax.annotation.Nullable UUID configIdFilter) {
  ...
  public ProxyProfileSelectionRule environmentIdFilter(@javax.annotation.Nullable UUID environmentIdFilter) {
  ...
  public ProxyProfileSelectionRule productNameMatchFilter(@javax.annotation.Nullable String productNameMatchFilter) {
  ...
  public ProxyProfileSelectionRule configNameMatchFilter(@javax.annotation.Nullable String configNameMatchFilter) {
  ...
  public ProxyProfileSelectionRule environmentNameMatchFilter(@javax.annotation.Nullable String environmentNameMatchFilter) {
   ...
   * @return the ProxyProfileSelectionRule instance itself
   */
  public ProxyProfileSelectionRule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProxyProfileSelectionRule proxyProfileSelectionRule = (ProxyProfileSelectionRule) o;
    return Objects.equals(this.kind, proxyProfileSelectionRule.kind) &&
        Objects.equals(this.productIdFilter, proxyProfileSelectionRule.productIdFilter) &&
        Objects.equals(this.configIdFilter, proxyProfileSelectionRule.configIdFilter) &&
        Objects.equals(this.environmentIdFilter, proxyProfileSelectionRule.environmentIdFilter) &&
        Objects.equals(this.productNameMatchFilter, proxyProfileSelectionRule.productNameMatchFilter) &&
        Objects.equals(this.configNameMatchFilter, proxyProfileSelectionRule.configNameMatchFilter) &&
        Objects.equals(this.environmentNameMatchFilter, proxyProfileSelectionRule.environmentNameMatchFilter)&&
        Objects.equals(this.additionalProperties, proxyProfileSelectionRule.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProxyProfileSelectionRule {\n");
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("kind", "productIdFilter", "configIdFilter", "environmentIdFilter", "productNameMatchFilter", "configNameMatchFilter", "environmentNameMatchFilter"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProxyProfileSelectionRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProxyProfileSelectionRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProxyProfileSelectionRule is not found in the empty JSON string", ProxyProfileSelectionRule.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProxyProfileSelectionRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyProfileSelectionRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyProfileSelectionRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyProfileSelectionRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyProfileSelectionRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyProfileSelectionRule>() {
           @Override
           public void write(JsonWriter out, ProxyProfileSelectionRule value) throws IOException {
           ...
           @Override
           public ProxyProfileSelectionRule read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ProxyProfileSelectionRule instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ProxyProfileSelectionRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProxyProfileSelectionRule
   * @throws IOException if the JSON string is invalid with respect to ProxyProfileSelectionRule
   */
  public static ProxyProfileSelectionRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyProfileSelectionRule.class);
  }

  /**
   * Convert an instance of ProxyProfileSelectionRule to an JSON string
   *
   * @return JSON string
   */
