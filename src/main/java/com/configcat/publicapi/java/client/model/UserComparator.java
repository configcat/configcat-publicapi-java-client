...
/**
 * The comparison operator which defines the relation between the comparison attribute and the
 * comparison value.
 */
...
public enum UserComparator {
    ...
    public static class Adapter extends TypeAdapter<UserComparator> {
        @Override
        public void write(final JsonWriter jsonWriter, final UserComparator enumeration)
                throws IOException {
