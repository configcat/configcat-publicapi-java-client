...
public class FeatureFlagsSettingsApi {
    ...
    public SettingModel createSetting(
            ...
            throws ApiException {
        ApiResponse<SettingModel> localVarResp =
     ...
     * </table>
     */
    public ApiResponse<SettingModel> createSettingWithHttpInfo(
            UUID configId, CreateSettingInitialValues createSettingInitialValues)
            throws ApiException {
    ...
    public okhttp3.Call createSettingAsync(
            UUID configId,
            CreateSettingInitialValues createSettingInitialValues,
            final ApiCallback<SettingModel> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call deleteSettingAsync(Integer settingId, final ApiCallback<Void> _callback)
            throws ApiException {
    ...
    public okhttp3.Call getSettingAsync(
            Integer settingId, final ApiCallback<SettingModel> _callback) throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<List<SettingModel>> getSettingsWithHttpInfo(UUID configId)
            throws ApiException {
    ...
    public okhttp3.Call getSettingsAsync(
            UUID configId, final ApiCallback<List<SettingModel>> _callback) throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<SettingModel> replaceSettingWithHttpInfo(
    ...
    public SettingModel updateSetting(
            Integer settingId, List<JsonPatchOperation> jsonPatchOperation) throws ApiException {
        ApiResponse<SettingModel> localVarResp =
     ...
     * </table>
     */
    public ApiResponse<SettingModel> updateSettingWithHttpInfo(
            Integer settingId, List<JsonPatchOperation> jsonPatchOperation) throws ApiException {
        okhttp3.Call localVarCall =
