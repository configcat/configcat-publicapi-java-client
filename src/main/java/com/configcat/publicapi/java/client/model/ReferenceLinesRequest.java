...
import com.configcat.publicapi.java.client.model.ReferenceLineRequest;
...
public class ReferenceLinesRequest {
  ...
  public ReferenceLinesRequest addPreLinesItem(ReferenceLineRequest preLinesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ReferenceLineRequest> getPreLines() {
    return preLines;
  }
  ...
  public ReferenceLinesRequest addPostLinesItem(ReferenceLineRequest postLinesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ReferenceLineRequest> getPostLines() {
    return postLines;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ReferenceLineRequest getReferenceLine() {
    return referenceLine;
  }
   ...
   * @return the ReferenceLinesRequest instance itself
   */
  public ReferenceLinesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReferenceLinesRequest referenceLinesRequest = (ReferenceLinesRequest) o;
    return Objects.equals(this._file, referenceLinesRequest._file) &&
        Objects.equals(this.fileUrl, referenceLinesRequest.fileUrl) &&
        Objects.equals(this.preLines, referenceLinesRequest.preLines) &&
        Objects.equals(this.postLines, referenceLinesRequest.postLines) &&
        Objects.equals(this.referenceLine, referenceLinesRequest.referenceLine)&&
        Objects.equals(this.additionalProperties, referenceLinesRequest.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReferenceLinesRequest
   */
      ...
      if (jsonObj.get("preLines") != null && !jsonObj.get("preLines").isJsonNull()) {
        ...
        if (jsonArraypreLines != null) {
          ...
          for (int i = 0; i < jsonArraypreLines.size(); i++) {
            ReferenceLineRequest.validateJsonElement(jsonArraypreLines.get(i));
          };
        }
      }
      if (jsonObj.get("postLines") != null && !jsonObj.get("postLines").isJsonNull()) {
        ...
        if (jsonArraypostLines != null) {
          ...
          for (int i = 0; i < jsonArraypostLines.size(); i++) {
            ReferenceLineRequest.validateJsonElement(jsonArraypostLines.get(i));
          };
        }
      }
      // validate the required field `referenceLine`
      ReferenceLineRequest.validateJsonElement(jsonObj.get("referenceLine"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReferenceLinesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReferenceLinesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReferenceLinesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReferenceLinesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ReferenceLinesRequest>() {
           @Override
           public void write(JsonWriter out, ReferenceLinesRequest value) throws IOException {
           ...
           @Override
           public ReferenceLinesRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReferenceLinesRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ReferenceLinesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReferenceLinesRequest
   * @throws IOException if the JSON string is invalid with respect to ReferenceLinesRequest
   */
  public static ReferenceLinesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReferenceLinesRequest.class);
  }

  /**
   * Convert an instance of ReferenceLinesRequest to an JSON string
   *
   * @return JSON string
   */
