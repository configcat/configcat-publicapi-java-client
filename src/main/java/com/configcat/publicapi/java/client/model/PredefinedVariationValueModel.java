...
public class PredefinedVariationValueModel {
   ...
   * @return the PredefinedVariationValueModel instance itself
   */
  public PredefinedVariationValueModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PredefinedVariationValueModel predefinedVariationValueModel = (PredefinedVariationValueModel) o;
    return Objects.equals(this.boolValue, predefinedVariationValueModel.boolValue) &&
        Objects.equals(this.stringValue, predefinedVariationValueModel.stringValue) &&
        Objects.equals(this.intValue, predefinedVariationValueModel.intValue) &&
        Objects.equals(this.doubleValue, predefinedVariationValueModel.doubleValue)&&
        Objects.equals(this.additionalProperties, predefinedVariationValueModel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PredefinedVariationValueModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PredefinedVariationValueModel
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PredefinedVariationValueModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PredefinedVariationValueModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PredefinedVariationValueModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PredefinedVariationValueModel.class));

       return (TypeAdapter<T>) new TypeAdapter<PredefinedVariationValueModel>() {
           @Override
           public void write(JsonWriter out, PredefinedVariationValueModel value) throws IOException {
           ...
           @Override
           public PredefinedVariationValueModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PredefinedVariationValueModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PredefinedVariationValueModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PredefinedVariationValueModel
   * @throws IOException if the JSON string is invalid with respect to PredefinedVariationValueModel
   */
  public static PredefinedVariationValueModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PredefinedVariationValueModel.class);
  }

  /**
   * Convert an instance of PredefinedVariationValueModel to an JSON string
   *
   * @return JSON string
   */
