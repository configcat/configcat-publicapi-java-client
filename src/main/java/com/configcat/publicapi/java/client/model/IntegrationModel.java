...
public class IntegrationModel {
  ...
  public IntegrationModel integrationType(IntegrationTypeEnum integrationType) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(product, integrationId, name, integrationType, parameters, environmentIds, configIds);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntegrationModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntegrationModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
