...
public class UpdateSettingValueWithSettingIdModel {
    ...
    public UpdateSettingValueWithSettingIdModel addRolloutRulesItem(
            RolloutRuleModel rolloutRulesItem) {
    ...
    public UpdateSettingValueWithSettingIdModel rolloutPercentageItems(
            List<RolloutPercentageItemModel> rolloutPercentageItems) {
        this.rolloutPercentageItems = rolloutPercentageItems;
        return this;
    }

    public UpdateSettingValueWithSettingIdModel addRolloutPercentageItemsItem(
    ...
    public boolean equals(Object o) {
        ...
        UpdateSettingValueWithSettingIdModel updateSettingValueWithSettingIdModel =
                (UpdateSettingValueWithSettingIdModel) o;
        return Objects.equals(this.rolloutRules, updateSettingValueWithSettingIdModel.rolloutRules)
                && Objects.equals(
                        this.rolloutPercentageItems,
                        updateSettingValueWithSettingIdModel.rolloutPercentageItems)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(rolloutRules, rolloutPercentageItems, value, settingId);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateSettingValueWithSettingIdModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateSettingValueWithSettingIdModel"
                                        + " is not found in the empty JSON string",
                                UpdateSettingValueWithSettingIdModel.openapiRequiredFields
                                        .toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `UpdateSettingValueWithSettingIdModel` properties. JSON:"
                                    + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateSettingValueWithSettingIdModel.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateSettingValueWithSettingIdModel'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<UpdateSettingValueWithSettingIdModel> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(UpdateSettingValueWithSettingIdModel.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateSettingValueWithSettingIdModel>() {
                        @Override
                        public void write(
                                JsonWriter out, UpdateSettingValueWithSettingIdModel value)
                                throws IOException {
                        ...
                        @Override
                        public UpdateSettingValueWithSettingIdModel read(JsonReader in)
                                throws IOException {
     ...
     *     UpdateSettingValueWithSettingIdModel
     */
    public static UpdateSettingValueWithSettingIdModel fromJson(String jsonString)
            throws IOException {
