...
public class ProductsApi {
    ...
    public okhttp3.Call getProductPreferencesCall(UUID productId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v1/products/{productId}/preferences"
            .replace("{" + "productId" + "}", localVarApiClient.escapeString(productId.toString()));
     ...
     */
    public okhttp3.Call getProductsAsync(final ApiCallback<List<ProductModel>> _callback) throws ApiException {
