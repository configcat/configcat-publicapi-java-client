...
public class OrganizationLimitations {
   ...
   * @return the OrganizationLimitations instance itself
   */
  public OrganizationLimitations putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationLimitations organizationLimitations = (OrganizationLimitations) o;
    return Objects.equals(this.maxPercentageOptionCount, organizationLimitations.maxPercentageOptionCount) &&
        Objects.equals(this.maxTargetingRuleCount, organizationLimitations.maxTargetingRuleCount) &&
        Objects.equals(this.maxComparisonValueLength, organizationLimitations.maxComparisonValueLength) &&
        Objects.equals(this.maxComparisonValueListLength, organizationLimitations.maxComparisonValueListLength) &&
        Objects.equals(this.maxComparisonValueListItemLength, organizationLimitations.maxComparisonValueListItemLength) &&
        Objects.equals(this.maxStringFlagValueLength, organizationLimitations.maxStringFlagValueLength) &&
        Objects.equals(this.maxConditionPerTargetingRuleCount, organizationLimitations.maxConditionPerTargetingRuleCount) &&
        Objects.equals(this.maxPredefinedVariations, organizationLimitations.maxPredefinedVariations)&&
        Objects.equals(this.additionalProperties, organizationLimitations.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxPercentageOptionCount, maxTargetingRuleCount, maxComparisonValueLength, maxComparisonValueListLength, maxComparisonValueListItemLength, maxStringFlagValueLength, maxConditionPerTargetingRuleCount, maxPredefinedVariations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrganizationLimitations {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationLimitations
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationLimitations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationLimitations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationLimitations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationLimitations.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationLimitations>() {
           @Override
           public void write(JsonWriter out, OrganizationLimitations value) throws IOException {
           ...
           @Override
           public OrganizationLimitations read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OrganizationLimitations instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of OrganizationLimitations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationLimitations
   * @throws IOException if the JSON string is invalid with respect to OrganizationLimitations
   */
  public static OrganizationLimitations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationLimitations.class);
  }

  /**
   * Convert an instance of OrganizationLimitations to an JSON string
   *
   * @return JSON string
   */
