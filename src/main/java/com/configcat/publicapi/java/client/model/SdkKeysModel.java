...
public class SdkKeysModel {
   ...
   * @return the SdkKeysModel instance itself
   */
  public SdkKeysModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.primary, sdkKeysModel.primary) &&
        ...
        Objects.equals(this.additionalProperties, sdkKeysModel.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SdkKeysModel>() {
           ...
           public SdkKeysModel read(JsonReader in) throws IOException {
             ...
             SdkKeysModel instance = thisAdapter.fromJsonTree(jsonObj);
