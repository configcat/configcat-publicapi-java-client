...
public class WebhookNotification {
   ...
   * @return the WebhookNotification instance itself
   */
  public WebhookNotification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.webhookProxyUrl, webhookNotification.webhookProxyUrl) &&
        Objects.equals(this.signingKey1, webhookNotification.signingKey1) &&
        Objects.equals(this.signingKey2, webhookNotification.signingKey2)&&
        Objects.equals(this.additionalProperties, webhookNotification.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(webhookProxyUrl, signingKey1, signingKey2, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookNotification>() {
           ...
           public WebhookNotification read(JsonReader in) throws IOException {
             ...
             WebhookNotification instance = thisAdapter.fromJsonTree(jsonObj);
