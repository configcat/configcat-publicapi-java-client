...
public class FeatureFlagSettingValuesUsingSdkKeyApi {
    ...
    private okhttp3.Call updateSettingValueBySdkkeyValidateBeforeCall(String settingKeyOrId, List<JsonPatchOperation> jsonPatchOperation, String reason, String X_CONFIGCAT_SDKKEY, final ApiCallback _callback) throws ApiException {
        ...
        if (jsonPatchOperation == null) {
            throw new ApiException("Missing the required parameter 'jsonPatchOperation' when calling updateSettingValueBySdkkey(Async)");
        }

        return updateSettingValueBySdkkeyCall(settingKeyOrId, jsonPatchOperation, reason, X_CONFIGCAT_SDKKEY, _callback);
