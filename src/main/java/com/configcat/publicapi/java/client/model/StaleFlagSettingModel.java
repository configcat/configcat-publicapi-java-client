...
import com.configcat.publicapi.java.client.model.StaleFlagSettingTagModel;
import com.configcat.publicapi.java.client.model.StaleFlagSettingValueModel;
...
public class StaleFlagSettingModel {
   ...
   */
  @javax.annotation.Nonnull
  public Boolean getHasCodeReferences() {
    return hasCodeReferences;
  }
  ...
  public StaleFlagSettingModel addTagsItem(StaleFlagSettingTagModel tagsItem) {
    if (this.tags == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<StaleFlagSettingTagModel> getTags() {
    return tags;
  }
  ...
  public StaleFlagSettingModel addSettingValuesItem(StaleFlagSettingValueModel settingValuesItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<StaleFlagSettingValueModel> getSettingValues() {
    return settingValues;
  }
   ...
   * @return the StaleFlagSettingModel instance itself
   */
  public StaleFlagSettingModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StaleFlagSettingModel staleFlagSettingModel = (StaleFlagSettingModel) o;
    return Objects.equals(this.settingId, staleFlagSettingModel.settingId) &&
        Objects.equals(this.name, staleFlagSettingModel.name) &&
        Objects.equals(this.key, staleFlagSettingModel.key) &&
        Objects.equals(this.hint, staleFlagSettingModel.hint) &&
        Objects.equals(this.hasCodeReferences, staleFlagSettingModel.hasCodeReferences) &&
        Objects.equals(this.tags, staleFlagSettingModel.tags) &&
        Objects.equals(this.settingValues, staleFlagSettingModel.settingValues)&&
        Objects.equals(this.additionalProperties, staleFlagSettingModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(settingId, name, key, hint, hasCodeReferences, tags, settingValues, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StaleFlagSettingModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StaleFlagSettingModel
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StaleFlagSettingModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StaleFlagSettingModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StaleFlagSettingModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StaleFlagSettingModel.class));

       return (TypeAdapter<T>) new TypeAdapter<StaleFlagSettingModel>() {
           @Override
           public void write(JsonWriter out, StaleFlagSettingModel value) throws IOException {
           ...
           @Override
           public StaleFlagSettingModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             StaleFlagSettingModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of StaleFlagSettingModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StaleFlagSettingModel
   * @throws IOException if the JSON string is invalid with respect to StaleFlagSettingModel
   */
  public static StaleFlagSettingModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StaleFlagSettingModel.class);
  }

  /**
   * Convert an instance of StaleFlagSettingModel to an JSON string
   *
   * @return JSON string
   */
