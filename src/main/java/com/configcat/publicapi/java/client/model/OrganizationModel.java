...
public class OrganizationModel {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrganizationModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrganizationModel is not found in the"
                                        + " empty JSON string",
                                OrganizationModel.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OrganizationModel` properties. JSON: %s",
        ...
        if ((jsonObj.get("organizationId") != null && !jsonObj.get("organizationId").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `organizationId` to be a primitive type in the"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<OrganizationModel>() {
                        @Override
                        public void write(JsonWriter out, OrganizationModel value)
                                throws IOException {
