...
public class ConfigsApi {
    ...
    public ConfigModel createConfig(UUID productId, CreateConfigRequest createConfigRequest)
            throws ApiException {
        ApiResponse<ConfigModel> localVarResp =
     ...
     * </table>
     */
    public ApiResponse<ConfigModel> createConfigWithHttpInfo(
    ...
    public okhttp3.Call createConfigAsync(
            ...
            final ApiCallback<ConfigModel> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call deleteConfigAsync(UUID configId, final ApiCallback<Void> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getConfigAsync(UUID configId, final ApiCallback<ConfigModel> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<List<ConfigModel>> getConfigsWithHttpInfo(UUID productId)
            throws ApiException {
    ...
    /**
     * List Configs (asynchronously) This endpoint returns the list of the Configs that belongs to
     ...
     * </table>
     */
    public okhttp3.Call getConfigsAsync(
            UUID productId, final ApiCallback<List<ConfigModel>> _callback) throws ApiException {
    ...
    public okhttp3.Call updateConfigCall(
            UUID configId, UpdateConfigRequest updateConfigRequest, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    private okhttp3.Call updateConfigValidateBeforeCall(
        ...
        if (configId == null) {
            throw new ApiException(
                    "Missing the required parameter 'configId' when calling updateConfig(Async)");
        }
    ...
    /**
     * Update Config This endpoint updates a Config identified by the &#x60;configId&#x60;
     * parameter.
     *
     * @param configId The identifier of the Config. (required)
     * @param updateConfigRequest (required)
     ...
     * </table>
     */
    public ConfigModel updateConfig(UUID configId, UpdateConfigRequest updateConfigRequest)
            throws ApiException {
        ApiResponse<ConfigModel> localVarResp =
                updateConfigWithHttpInfo(configId, updateConfigRequest);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<ConfigModel> updateConfigWithHttpInfo(
            UUID configId, UpdateConfigRequest updateConfigRequest) throws ApiException {
        okhttp3.Call localVarCall =
                updateConfigValidateBeforeCall(configId, updateConfigRequest, null);
        Type localVarReturnType = new TypeToken<ConfigModel>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update Config (asynchronously) This endpoint updates a Config identified by the
     * &#x60;configId&#x60; parameter.
     *
     * @param configId The identifier of the Config. (required)
     * @param updateConfigRequest (required)
    ...
    public okhttp3.Call updateConfigAsync(
        ...
        okhttp3.Call localVarCall =
                updateConfigValidateBeforeCall(configId, updateConfigRequest, _callback);
        Type localVarReturnType = new TypeToken<ConfigModel>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
