...
public class ConnectRequest {
   ...
   * @return the ConnectRequest instance itself
   */
  public ConnectRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientKey, connectRequest.clientKey) &&
        ...
        Objects.equals(this.additionalProperties, connectRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientKey, jiraJwtToken, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConnectRequest>() {
           ...
           public ConnectRequest read(JsonReader in) throws IOException {
             ...
             ConnectRequest instance = thisAdapter.fromJsonTree(jsonObj);
