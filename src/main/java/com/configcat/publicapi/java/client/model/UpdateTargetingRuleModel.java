...
import com.configcat.publicapi.java.client.model.UpdateConditionModel;
import com.configcat.publicapi.java.client.model.UpdatePercentageOptionModel;
...
public class UpdateTargetingRuleModel {
  ...
  public UpdateTargetingRuleModel addConditionsItem(UpdateConditionModel conditionsItem) {
  ...
  public List<UpdateConditionModel> getConditions() {
    return conditions;
  }
  ...
  public UpdateTargetingRuleModel addPercentageOptionsItem(UpdatePercentageOptionModel percentageOptionsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<UpdatePercentageOptionModel> getPercentageOptions() {
    return percentageOptions;
  }
   ...
   */
  @javax.annotation.Nullable
  public UpdateValueModel getValue() {
    return value;
  }
   ...
   * @return the UpdateTargetingRuleModel instance itself
   */
  public UpdateTargetingRuleModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateTargetingRuleModel updateTargetingRuleModel = (UpdateTargetingRuleModel) o;
    return Objects.equals(this.conditions, updateTargetingRuleModel.conditions) &&
        Objects.equals(this.percentageOptions, updateTargetingRuleModel.percentageOptions) &&
        Objects.equals(this.value, updateTargetingRuleModel.value)&&
        Objects.equals(this.additionalProperties, updateTargetingRuleModel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateTargetingRuleModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateTargetingRuleModel
   */
      ...
      if (jsonObj.get("conditions") != null && !jsonObj.get("conditions").isJsonNull()) {
        ...
        if (jsonArrayconditions != null) {
          ...
          for (int i = 0; i < jsonArrayconditions.size(); i++) {
            UpdateConditionModel.validateJsonElement(jsonArrayconditions.get(i));
          };
        }
      }
      if (jsonObj.get("percentageOptions") != null && !jsonObj.get("percentageOptions").isJsonNull()) {
        ...
        if (jsonArraypercentageOptions != null) {
          ...
          for (int i = 0; i < jsonArraypercentageOptions.size(); i++) {
            UpdatePercentageOptionModel.validateJsonElement(jsonArraypercentageOptions.get(i));
          };
        }
      }
      // validate the optional field `value`
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        UpdateValueModel.validateJsonElement(jsonObj.get("value"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTargetingRuleModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTargetingRuleModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTargetingRuleModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTargetingRuleModel.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTargetingRuleModel>() {
           @Override
           public void write(JsonWriter out, UpdateTargetingRuleModel value) throws IOException {
           ...
           @Override
           public UpdateTargetingRuleModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateTargetingRuleModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpdateTargetingRuleModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateTargetingRuleModel
   * @throws IOException if the JSON string is invalid with respect to UpdateTargetingRuleModel
   */
  public static UpdateTargetingRuleModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTargetingRuleModel.class);
  }

  /**
   * Convert an instance of UpdateTargetingRuleModel to an JSON string
   *
   * @return JSON string
   */
