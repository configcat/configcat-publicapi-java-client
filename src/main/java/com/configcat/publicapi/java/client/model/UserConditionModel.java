...
public class UserConditionModel {
  ...
  public UserConditionModel comparator(ComparatorEnum comparator) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserConditionModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserConditionModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
