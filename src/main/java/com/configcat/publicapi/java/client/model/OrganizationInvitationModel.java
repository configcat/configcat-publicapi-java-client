...
public class OrganizationInvitationModel {
  ...
  public OrganizationInvitationModel invitationId(@javax.annotation.Nonnull UUID invitationId) {
  ...
  public OrganizationInvitationModel email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public OrganizationInvitationModel productId(@javax.annotation.Nonnull UUID productId) {
  ...
  public OrganizationInvitationModel productName(@javax.annotation.Nullable String productName) {
  ...
  public OrganizationInvitationModel permissionGroupId(@javax.annotation.Nonnull Long permissionGroupId) {
  ...
  public OrganizationInvitationModel createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public OrganizationInvitationModel expired(@javax.annotation.Nonnull Boolean expired) {
  ...
  public OrganizationInvitationModel expires(@javax.annotation.Nonnull OffsetDateTime expires) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("invitationId", "email", "productId", "productName", "permissionGroupId", "createdAt", "expired", "expires"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("invitationId", "email", "productId", "productName", "permissionGroupId", "createdAt", "expired", "expires"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationInvitationModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrganizationInvitationModel is not found in the empty JSON string", OrganizationInvitationModel.openapiRequiredFields.toString()));
        }
      }
