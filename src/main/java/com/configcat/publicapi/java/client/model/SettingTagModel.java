...
public class SettingTagModel {
   ...
   * @return the SettingTagModel instance itself
   */
  public SettingTagModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SettingTagModel>() {
           ...
           public SettingTagModel read(JsonReader in) throws IOException {
             ...
             SettingTagModel instance = thisAdapter.fromJsonTree(jsonObj);
