...
import com.configcat.publicapi.java.client.model.UpdateComparisonValueModel;
...
public class UpdateUserConditionModel {
   ...
   */
  @javax.annotation.Nonnull
  public UpdateComparisonValueModel getComparisonValue() {
    return comparisonValue;
  }
   ...
   * @return the UpdateUserConditionModel instance itself
   */
  public UpdateUserConditionModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserConditionModel updateUserConditionModel = (UpdateUserConditionModel) o;
    return Objects.equals(this.comparisonAttribute, updateUserConditionModel.comparisonAttribute) &&
        Objects.equals(this.comparator, updateUserConditionModel.comparator) &&
        Objects.equals(this.comparisonValue, updateUserConditionModel.comparisonValue)&&
        Objects.equals(this.additionalProperties, updateUserConditionModel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateUserConditionModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserConditionModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      UpdateComparisonValueModel.validateJsonElement(jsonObj.get("comparisonValue"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserConditionModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserConditionModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserConditionModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserConditionModel.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserConditionModel>() {
           @Override
           public void write(JsonWriter out, UpdateUserConditionModel value) throws IOException {
           ...
           @Override
           public UpdateUserConditionModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateUserConditionModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpdateUserConditionModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserConditionModel
   * @throws IOException if the JSON string is invalid with respect to UpdateUserConditionModel
   */
  public static UpdateUserConditionModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserConditionModel.class);
  }

  /**
   * Convert an instance of UpdateUserConditionModel to an JSON string
   *
   * @return JSON string
   */
