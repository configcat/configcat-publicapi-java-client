...
public class AuditLogItemModel {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AuditLogItemModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AuditLogItemModel is not found in the"
                                        + " empty JSON string",
                                AuditLogItemModel.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AuditLogItemModel` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        // validate the optional field `auditLogTypeEnum`
        if (jsonObj.get("auditLogTypeEnum") != null
                && !jsonObj.get("auditLogTypeEnum").isJsonNull()) {
        ...
        if ((jsonObj.get("changeSetId") != null && !jsonObj.get("changeSetId").isJsonNull())
                && !jsonObj.get("changeSetId").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `changeSetId` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("changeSetId").toString()));
        }
        if ((jsonObj.get("auditLogType") != null && !jsonObj.get("auditLogType").isJsonNull())
                && !jsonObj.get("auditLogType").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `auditLogType` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("auditLogType").toString()));
        }
        ...
        if ((jsonObj.get("where") != null && !jsonObj.get("where").isJsonNull())
                && !jsonObj.get("where").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `where` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("where").toString()));
        }
        if ((jsonObj.get("why") != null && !jsonObj.get("why").isJsonNull())
                && !jsonObj.get("why").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `why` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("why").toString()));
        }
        if ((jsonObj.get("actionTarget") != null && !jsonObj.get("actionTarget").isJsonNull())
                && !jsonObj.get("actionTarget").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `actionTarget` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("actionTarget").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<AuditLogItemModel>() {
                        @Override
                        public void write(JsonWriter out, AuditLogItemModel value)
                                throws IOException {
