...
public class SettingValueModel {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.rolloutRules, settingValueModel.rolloutRules)
                && Objects.equals(
                        this.rolloutPercentageItems, settingValueModel.rolloutPercentageItems)
                ...
                && Objects.equals(
                        this.lastUpdaterUserFullName, settingValueModel.lastUpdaterUserFullName)
                ...
                && Objects.equals(
                        this.featureFlagLimitations, settingValueModel.featureFlagLimitations)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SettingValueModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SettingValueModel is not found in the"
                                        + " empty JSON string",
                                SettingValueModel.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `SettingValueModel` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SettingValueModel>() {
                        @Override
                        public void write(JsonWriter out, SettingValueModel value)
                                throws IOException {
