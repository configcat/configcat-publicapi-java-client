...
public class InvitationModel {
   ...
   * @return the InvitationModel instance itself
   */
  public InvitationModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvitationModel>() {
           ...
           public InvitationModel read(JsonReader in) throws IOException {
             ...
             InvitationModel instance = thisAdapter.fromJsonTree(jsonObj);
