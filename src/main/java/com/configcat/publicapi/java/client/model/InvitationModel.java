...
public class InvitationModel {
  ...
  public boolean equals(Object o) {
    ...
    InvitationModel invitationModel = (InvitationModel) o;
    return Objects.equals(this.invitationId, invitationModel.invitationId) &&
        Objects.equals(this.email, invitationModel.email) &&
        Objects.equals(this.permissionGroupId, invitationModel.permissionGroupId) &&
        Objects.equals(this.createdAt, invitationModel.createdAt) &&
        Objects.equals(this.expired, invitationModel.expired);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(invitationId, email, permissionGroupId, createdAt, expired);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InvitationModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvitationModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InvitationModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvitationModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvitationModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvitationModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvitationModel.class));

       return (TypeAdapter<T>) new TypeAdapter<InvitationModel>() {
           @Override
           public void write(JsonWriter out, InvitationModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InvitationModel read(JsonReader in) throws IOException {
   ...
   * @return An instance of InvitationModel
   * @throws IOException if the JSON string is invalid with respect to InvitationModel
   */
  public static InvitationModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvitationModel.class);
  }
