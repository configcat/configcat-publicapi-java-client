...
public class CreateIntegrationModel {
   ...
   * @return the CreateIntegrationModel instance itself
   */
  public CreateIntegrationModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.integrationType, createIntegrationModel.integrationType) &&
        ...
        Objects.equals(this.additionalProperties, createIntegrationModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrationType, name, parameters, environmentIds, configIds, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateIntegrationModel>() {
           ...
           public CreateIntegrationModel read(JsonReader in) throws IOException {
             ...
             CreateIntegrationModel instance = thisAdapter.fromJsonTree(jsonObj);
