...
public class UpdatePermissionGroupRequest {
   ...
   * @return the UpdatePermissionGroupRequest instance itself
   */
  public UpdatePermissionGroupRequest putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdatePermissionGroupRequest>() {
           ...
           public UpdatePermissionGroupRequest read(JsonReader in) throws IOException {
             ...
             UpdatePermissionGroupRequest instance = thisAdapter.fromJsonTree(jsonObj);
