...
public class FlagReference {
   ...
   * @return the FlagReference instance itself
   */
  public FlagReference putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.settingId, flagReference.settingId) &&
        ...
        Objects.equals(this.additionalProperties, flagReference.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(settingId, references, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FlagReference>() {
           ...
           public FlagReference read(JsonReader in) throws IOException {
             ...
             FlagReference instance = thisAdapter.fromJsonTree(jsonObj);
