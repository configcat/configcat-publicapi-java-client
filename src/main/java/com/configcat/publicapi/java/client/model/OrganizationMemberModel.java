...
public class OrganizationMemberModel {
   ...
   * @return the OrganizationMemberModel instance itself
   */
  public OrganizationMemberModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrganizationMemberModel>() {
           ...
           public OrganizationMemberModel read(JsonReader in) throws IOException {
             ...
             OrganizationMemberModel instance = thisAdapter.fromJsonTree(jsonObj);
