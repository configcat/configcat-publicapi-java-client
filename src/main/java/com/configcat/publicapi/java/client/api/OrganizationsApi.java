...
public class OrganizationsApi {
    ...
    private okhttp3.Call getOrganizationsValidateBeforeCall(final ApiCallback _callback)
            throws ApiException {
     ...
     * </table>
     */
    public List<OrganizationModel> getOrganizations() throws ApiException {
        ApiResponse<List<OrganizationModel>> localVarResp = getOrganizationsWithHttpInfo();
     ...
     * </table>
     */
    public ApiResponse<List<OrganizationModel>> getOrganizationsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getOrganizationsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<OrganizationModel>>() {}.getType();
     ...
     * </table>
     */
    public okhttp3.Call getOrganizationsAsync(final ApiCallback<List<OrganizationModel>> _callback)
            throws ApiException {
