...
public class WebhookConfig {
  ...
  public WebhookConfig name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public WebhookConfig configId(@javax.annotation.Nonnull UUID configId) {
   ...
   * @return the WebhookConfig instance itself
   */
  public WebhookConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, webhookConfig.name) &&
        Objects.equals(this.configId, webhookConfig.configId)&&
        Objects.equals(this.additionalProperties, webhookConfig.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, configId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "configId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "configId"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookConfig>() {
           ...
           public WebhookConfig read(JsonReader in) throws IOException {
             ...
             WebhookConfig instance = thisAdapter.fromJsonTree(jsonObj);
