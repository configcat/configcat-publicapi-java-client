...
public class ReasonRequiredEnvironmentModel {
    ...
    public boolean equals(Object o) {
        ...
        ReasonRequiredEnvironmentModel reasonRequiredEnvironmentModel =
                (ReasonRequiredEnvironmentModel) o;
        return Objects.equals(this.environmentId, reasonRequiredEnvironmentModel.environmentId)
                && Objects.equals(
                        this.reasonRequired, reasonRequiredEnvironmentModel.reasonRequired)
                && Objects.equals(
                        this.environmentName, reasonRequiredEnvironmentModel.environmentName);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ReasonRequiredEnvironmentModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ReasonRequiredEnvironmentModel is not"
                                        + " found in the empty JSON string",
                                ReasonRequiredEnvironmentModel.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ReasonRequiredEnvironmentModel` properties. JSON: %s",
        ...
        if ((jsonObj.get("environmentName") != null && !jsonObj.get("environmentName").isJsonNull())
                && !jsonObj.get("environmentName").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `environmentName` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("environmentName").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ReasonRequiredEnvironmentModel.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ReasonRequiredEnvironmentModel' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ReasonRequiredEnvironmentModel> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ReasonRequiredEnvironmentModel.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ReasonRequiredEnvironmentModel>() {
                        @Override
                        public void write(JsonWriter out, ReasonRequiredEnvironmentModel value)
                                throws IOException {
                        ...
                        @Override
                        public ReasonRequiredEnvironmentModel read(JsonReader in)
                                throws IOException {
