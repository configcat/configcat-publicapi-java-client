...
public class ReasonRequiredEnvironmentModel {
   ...
   * @return the ReasonRequiredEnvironmentModel instance itself
   */
  public ReasonRequiredEnvironmentModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReasonRequiredEnvironmentModel>() {
           ...
           public ReasonRequiredEnvironmentModel read(JsonReader in) throws IOException {
             ...
             ReasonRequiredEnvironmentModel instance = thisAdapter.fromJsonTree(jsonObj);
