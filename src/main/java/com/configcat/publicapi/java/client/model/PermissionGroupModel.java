...
public class PermissionGroupModel {
    ...
    public PermissionGroupModel newEnvironmentAccessType(
    ...
    public PermissionGroupModel environmentAccesses(
            List<EnvironmentAccessModel> environmentAccesses) {
        this.environmentAccesses = environmentAccesses;
        return this;
    }

    public PermissionGroupModel addEnvironmentAccessesItem(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.permissionGroupId, permissionGroupModel.permissionGroupId)
                ...
                && Objects.equals(
                        this.canCreateOrUpdateConfig, permissionGroupModel.canCreateOrUpdateConfig)
                && Objects.equals(this.canDeleteConfig, permissionGroupModel.canDeleteConfig)
                && Objects.equals(
                        this.canCreateOrUpdateEnvironment,
                        permissionGroupModel.canCreateOrUpdateEnvironment)
                && Objects.equals(
                        this.canDeleteEnvironment, permissionGroupModel.canDeleteEnvironment)
                && Objects.equals(
                        this.canCreateOrUpdateSetting,
                        permissionGroupModel.canCreateOrUpdateSetting)
                ...
                && Objects.equals(
                        this.canCreateOrUpdateTag, permissionGroupModel.canCreateOrUpdateTag)
                ...
                && Objects.equals(
                        ...
                        permissionGroupModel.canManageProductPreferences)
                && Objects.equals(
                        this.canManageIntegrations, permissionGroupModel.canManageIntegrations)
                ...
                && Objects.equals(
                        ...
                        permissionGroupModel.canCreateOrUpdateSegments)
                && Objects.equals(this.canDeleteSegments, permissionGroupModel.canDeleteSegments)
                && Objects.equals(
                        this.canViewProductAuditLog, permissionGroupModel.canViewProductAuditLog)
                && Objects.equals(
                        this.canViewProductStatistics,
                        permissionGroupModel.canViewProductStatistics)
                ...
                && Objects.equals(
                        ...
                        permissionGroupModel.newEnvironmentAccessType)
                && Objects.equals(
                        this.environmentAccesses, permissionGroupModel.environmentAccesses)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PermissionGroupModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PermissionGroupModel is not found in"
                                        + " the empty JSON string",
                                PermissionGroupModel.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `PermissionGroupModel` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<PermissionGroupModel>() {
                        @Override
                        public void write(JsonWriter out, PermissionGroupModel value)
                                throws IOException {
