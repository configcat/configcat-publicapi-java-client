...
import com.configcat.publicapi.java.client.model.StaleFlagConfigModel;
import com.configcat.publicapi.java.client.model.StaleFlagEnvironmentModel;
...
public class StaleFlagProductModel {
  ...
  public StaleFlagProductModel addConfigsItem(StaleFlagConfigModel configsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<StaleFlagConfigModel> getConfigs() {
    return configs;
  }
  ...
  public StaleFlagProductModel addEnvironmentsItem(StaleFlagEnvironmentModel environmentsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<StaleFlagEnvironmentModel> getEnvironments() {
    return environments;
  }
   ...
   * @return the StaleFlagProductModel instance itself
   */
  public StaleFlagProductModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StaleFlagProductModel staleFlagProductModel = (StaleFlagProductModel) o;
    return Objects.equals(this.productId, staleFlagProductModel.productId) &&
        Objects.equals(this.name, staleFlagProductModel.name) &&
        Objects.equals(this.configs, staleFlagProductModel.configs) &&
        Objects.equals(this.environments, staleFlagProductModel.environments)&&
        Objects.equals(this.additionalProperties, staleFlagProductModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productId, name, configs, environments, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StaleFlagProductModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StaleFlagProductModel
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StaleFlagProductModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StaleFlagProductModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StaleFlagProductModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StaleFlagProductModel.class));

       return (TypeAdapter<T>) new TypeAdapter<StaleFlagProductModel>() {
           @Override
           public void write(JsonWriter out, StaleFlagProductModel value) throws IOException {
           ...
           @Override
           public StaleFlagProductModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             StaleFlagProductModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of StaleFlagProductModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StaleFlagProductModel
   * @throws IOException if the JSON string is invalid with respect to StaleFlagProductModel
   */
  public static StaleFlagProductModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StaleFlagProductModel.class);
  }

  /**
   * Convert an instance of StaleFlagProductModel to an JSON string
   *
   * @return JSON string
   */
