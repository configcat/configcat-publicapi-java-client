...
public class SegmentModel {
    ...
    public String toString() {
        ...
        sb.append("    lastUpdaterFullName: ")
                .append(toIndentedString(lastUpdaterFullName))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SegmentModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SegmentModel is not found in the"
                                        + " empty JSON string",
                                SegmentModel.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `SegmentModel` properties. JSON: %s",
        ...
        if ((jsonObj.get("lastUpdaterEmail") != null
                        && !jsonObj.get("lastUpdaterEmail").isJsonNull())
                && !jsonObj.get("lastUpdaterEmail").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `lastUpdaterEmail` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("lastUpdaterEmail").toString()));
        }
        if ((jsonObj.get("lastUpdaterFullName") != null
                        && !jsonObj.get("lastUpdaterFullName").isJsonNull())
                && !jsonObj.get("lastUpdaterFullName").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `lastUpdaterFullName` to be a primitive type in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("lastUpdaterFullName").toString()));
        }
