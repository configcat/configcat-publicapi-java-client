...
public class SegmentModel {
  ...
  public SegmentModel comparator(ComparatorEnum comparator) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(product, segmentId, name, description, creatorEmail, creatorFullName, createdAt, lastUpdaterEmail, lastUpdaterFullName, updatedAt, comparisonAttribute, comparator, comparisonValue);
  }
