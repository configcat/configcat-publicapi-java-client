...
public enum AuditLogType {
  ...
  AUTO_PROVISIONING_ENABLED_CHANGED("autoProvisioningEnabledChanged"),
  ...
  USER_PROVISIONING_CONFIGURATION_CHANGED("userProvisioningConfigurationChanged"),
  
  SYNC_GROUP_PROVISIONING_RULE_CHANGED("syncGroupProvisioningRuleChanged"),
  
  SYNC_GROUPS_REORDERED("syncGroupsReordered"),
  
  SYNC_USER_PROVISIONING_ENABLED("syncUserProvisioningEnabled"),
  
  SYNC_USER_PROVISIONING_DISABLED("syncUserProvisioningDisabled"),
  
  USER_EMAIL_CHANGED("userEmailChanged"),
  
  USER_FULL_NAME_CHANGED("userFullNameChanged"),
