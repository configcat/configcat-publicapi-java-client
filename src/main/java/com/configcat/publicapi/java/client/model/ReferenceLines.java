...
public class ReferenceLines {
    ...
    /**
     * The file&#39;s name in where the code reference has been found. (Appears on the ConfigCat
     * Dashboard)
     *
     * @return _file
     */
    ...
    @Override
    public int hashCode() {
        return Objects.hash(_file, fileUrl, preLines, postLines, referenceLine);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ReferenceLines.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ReferenceLines is not found in the"
                                        + " empty JSON string",
                                ReferenceLines.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ReferenceLines` properties. JSON: %s",
        ...
        if (!jsonObj.get("file").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `file` to be a primitive type in the JSON string"
                                    + " but got `%s`",
        ...
        if ((jsonObj.get("fileUrl") != null && !jsonObj.get("fileUrl").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `fileUrl` to be a primitive type in the JSON"
                                    + " string but got `%s`",
        ...
        if (jsonObj.get("preLines") != null && !jsonObj.get("preLines").isJsonNull()) {
            ...
            if (jsonArraypreLines != null) {
                ...
                if (!jsonObj.get("preLines").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `preLines` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("preLines").toString()));
                }
        ...
        if (jsonObj.get("postLines") != null && !jsonObj.get("postLines").isJsonNull()) {
            ...
            if (jsonArraypostLines != null) {
                ...
                if (!jsonObj.get("postLines").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `postLines` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("postLines").toString()));
                }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ReferenceLines>() {
                        @Override
