...
public class AddOrUpdateJiraIntegrationLinkModel {
    ...
    public boolean equals(Object o) {
        ...
        AddOrUpdateJiraIntegrationLinkModel addOrUpdateJiraIntegrationLinkModel =
                (AddOrUpdateJiraIntegrationLinkModel) o;
        return Objects.equals(this.jiraJwtToken, addOrUpdateJiraIntegrationLinkModel.jiraJwtToken)
                && Objects.equals(this.clientKey, addOrUpdateJiraIntegrationLinkModel.clientKey)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(jiraJwtToken, clientKey, description, url);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AddOrUpdateJiraIntegrationLinkModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AddOrUpdateJiraIntegrationLinkModel"
                                        + " is not found in the empty JSON string",
                                AddOrUpdateJiraIntegrationLinkModel.openapiRequiredFields
                                        .toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AddOrUpdateJiraIntegrationLinkModel` properties. JSON:"
                                        + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AddOrUpdateJiraIntegrationLinkModel.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AddOrUpdateJiraIntegrationLinkModel' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AddOrUpdateJiraIntegrationLinkModel> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AddOrUpdateJiraIntegrationLinkModel.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AddOrUpdateJiraIntegrationLinkModel>() {
                        @Override
                        public void write(JsonWriter out, AddOrUpdateJiraIntegrationLinkModel value)
                                throws IOException {
                        ...
                        @Override
                        public AddOrUpdateJiraIntegrationLinkModel read(JsonReader in)
                                throws IOException {
     ...
     *     AddOrUpdateJiraIntegrationLinkModel
     */
    public static AddOrUpdateJiraIntegrationLinkModel fromJson(String jsonString)
            throws IOException {
