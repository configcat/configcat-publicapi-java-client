...
public class SettingFormulaModel {
    ...
    public SettingFormulaModel settingIdsWherePrerequisite(
            List<Integer> settingIdsWherePrerequisite) {
        this.settingIdsWherePrerequisite = settingIdsWherePrerequisite;
        return this;
    }

    public SettingFormulaModel addSettingIdsWherePrerequisiteItem(
    ...
    public SettingFormulaModel featureFlagLimitations(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.lastVersionId, settingFormulaModel.lastVersionId)
                ...
                && Objects.equals(
                        ...
                        settingFormulaModel.percentageEvaluationAttribute)
                && Objects.equals(
                        this.lastUpdaterUserEmail, settingFormulaModel.lastUpdaterUserEmail)
                && Objects.equals(
                        this.lastUpdaterUserFullName, settingFormulaModel.lastUpdaterUserFullName)
                ...
                && Objects.equals(
                        ...
                        settingFormulaModel.settingIdsWherePrerequisite)
                ...
                && Objects.equals(
                        this.featureFlagLimitations, settingFormulaModel.featureFlagLimitations);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SettingFormulaModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SettingFormulaModel is not found in"
                                        + " the empty JSON string",
                                SettingFormulaModel.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `SettingFormulaModel` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SettingFormulaModel>() {
                        @Override
                        public void write(JsonWriter out, SettingFormulaModel value)
                                throws IOException {
