...
public class DeleteIntegrationLinkModel {
    public static final String SERIALIZED_NAME_HAS_REMAINING_INTEGRATION_LINK =
    ...
    public DeleteIntegrationLinkModel hasRemainingIntegrationLink(
            Boolean hasRemainingIntegrationLink) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(
                this.hasRemainingIntegrationLink,
                deleteIntegrationLinkModel.hasRemainingIntegrationLink);
    }
    ...
    public String toString() {
        ...
        sb.append("    hasRemainingIntegrationLink: ")
                .append(toIndentedString(hasRemainingIntegrationLink))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DeleteIntegrationLinkModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DeleteIntegrationLinkModel is not"
                                        + " found in the empty JSON string",
                                DeleteIntegrationLinkModel.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `DeleteIntegrationLinkModel` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteIntegrationLinkModel.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteIntegrationLinkModel' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<DeleteIntegrationLinkModel>() {
                        @Override
                        public void write(JsonWriter out, DeleteIntegrationLinkModel value)
                                throws IOException {
