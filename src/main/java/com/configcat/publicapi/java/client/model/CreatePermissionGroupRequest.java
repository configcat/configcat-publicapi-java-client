...
public class CreatePermissionGroupRequest {
    ...
    public CreatePermissionGroupRequest canCreateOrUpdateEnvironment(
    ...
    public CreatePermissionGroupRequest canManageProductPreferences(
    ...
    public CreatePermissionGroupRequest canCreateOrUpdateSegments(
    ...
    public CreatePermissionGroupRequest newEnvironmentAccessType(
    ...
    public CreatePermissionGroupRequest environmentAccesses(
            List<CreateOrUpdateEnvironmentAccessModel> environmentAccesses) {
        this.environmentAccesses = environmentAccesses;
        return this;
    }

    public CreatePermissionGroupRequest addEnvironmentAccessesItem(
    ...
    public boolean equals(Object o) {
        ...
        CreatePermissionGroupRequest createPermissionGroupRequest =
                (CreatePermissionGroupRequest) o;
        return Objects.equals(this.name, createPermissionGroupRequest.name)
                && Objects.equals(
                        this.canManageMembers, createPermissionGroupRequest.canManageMembers)
                && Objects.equals(
                        this.canCreateOrUpdateConfig,
                        createPermissionGroupRequest.canCreateOrUpdateConfig)
                && Objects.equals(
                        this.canDeleteConfig, createPermissionGroupRequest.canDeleteConfig)
                && Objects.equals(
                        this.canCreateOrUpdateEnvironment,
                        createPermissionGroupRequest.canCreateOrUpdateEnvironment)
                && Objects.equals(
                        this.canDeleteEnvironment,
                        createPermissionGroupRequest.canDeleteEnvironment)
                && Objects.equals(
                        this.canCreateOrUpdateSetting,
                        createPermissionGroupRequest.canCreateOrUpdateSetting)
                && Objects.equals(this.canTagSetting, createPermissionGroupRequest.canTagSetting)
                && Objects.equals(
                        this.canDeleteSetting, createPermissionGroupRequest.canDeleteSetting)
                && Objects.equals(
                        this.canCreateOrUpdateTag,
                        createPermissionGroupRequest.canCreateOrUpdateTag)
                && Objects.equals(this.canDeleteTag, createPermissionGroupRequest.canDeleteTag)
                && Objects.equals(
                        this.canManageWebhook, createPermissionGroupRequest.canManageWebhook)
                && Objects.equals(
                        this.canUseExportImport, createPermissionGroupRequest.canUseExportImport)
                && Objects.equals(
                        this.canManageProductPreferences,
                        createPermissionGroupRequest.canManageProductPreferences)
                && Objects.equals(
                        this.canManageIntegrations,
                        createPermissionGroupRequest.canManageIntegrations)
                && Objects.equals(this.canViewSdkKey, createPermissionGroupRequest.canViewSdkKey)
                && Objects.equals(
                        this.canRotateSdkKey, createPermissionGroupRequest.canRotateSdkKey)
                && Objects.equals(
                        this.canCreateOrUpdateSegments,
                        createPermissionGroupRequest.canCreateOrUpdateSegments)
                && Objects.equals(
                        this.canDeleteSegments, createPermissionGroupRequest.canDeleteSegments)
                && Objects.equals(
                        this.canViewProductAuditLog,
                        createPermissionGroupRequest.canViewProductAuditLog)
                && Objects.equals(
                        this.canViewProductStatistics,
                        createPermissionGroupRequest.canViewProductStatistics)
                && Objects.equals(this.accessType, createPermissionGroupRequest.accessType)
                && Objects.equals(
                        this.newEnvironmentAccessType,
                        createPermissionGroupRequest.newEnvironmentAccessType)
                && Objects.equals(
                        this.environmentAccesses, createPermissionGroupRequest.environmentAccesses)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CreatePermissionGroupRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreatePermissionGroupRequest is not"
                                        + " found in the empty JSON string",
                                CreatePermissionGroupRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `CreatePermissionGroupRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreatePermissionGroupRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreatePermissionGroupRequest' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CreatePermissionGroupRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CreatePermissionGroupRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CreatePermissionGroupRequest>() {
                        @Override
                        public void write(JsonWriter out, CreatePermissionGroupRequest value)
                                throws IOException {
