...
import com.configcat.publicapi.java.client.model.StaleFlagSettingModel;
...
public class StaleFlagConfigModel {
  ...
  public StaleFlagConfigModel addSettingsItem(StaleFlagSettingModel settingsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<StaleFlagSettingModel> getSettings() {
    return settings;
  }
   ...
   * @return the StaleFlagConfigModel instance itself
   */
  public StaleFlagConfigModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StaleFlagConfigModel staleFlagConfigModel = (StaleFlagConfigModel) o;
    return Objects.equals(this.configId, staleFlagConfigModel.configId) &&
        Objects.equals(this.name, staleFlagConfigModel.name) &&
        Objects.equals(this.evaluationVersion, staleFlagConfigModel.evaluationVersion) &&
        Objects.equals(this.hasCodeReferences, staleFlagConfigModel.hasCodeReferences) &&
        Objects.equals(this.settings, staleFlagConfigModel.settings)&&
        Objects.equals(this.additionalProperties, staleFlagConfigModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configId, name, evaluationVersion, hasCodeReferences, settings, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StaleFlagConfigModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StaleFlagConfigModel
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StaleFlagConfigModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StaleFlagConfigModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StaleFlagConfigModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StaleFlagConfigModel.class));

       return (TypeAdapter<T>) new TypeAdapter<StaleFlagConfigModel>() {
           @Override
           public void write(JsonWriter out, StaleFlagConfigModel value) throws IOException {
           ...
           @Override
           public StaleFlagConfigModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             StaleFlagConfigModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of StaleFlagConfigModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StaleFlagConfigModel
   * @throws IOException if the JSON string is invalid with respect to StaleFlagConfigModel
   */
  public static StaleFlagConfigModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StaleFlagConfigModel.class);
  }

  /**
   * Convert an instance of StaleFlagConfigModel to an JSON string
   *
   * @return JSON string
   */
