...
import com.configcat.publicapi.java.client.model.FlagReference;
...
public class CodeReferenceRequest {
   ...
   * @return the CodeReferenceRequest instance itself
   */
  public CodeReferenceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configId, codeReferenceRequest.configId) &&
        ...
        Objects.equals(this.additionalProperties, codeReferenceRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(configId, repository, branch, commitUrl, commitHash, uploader, activeBranches, flagReferences, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CodeReferenceRequest>() {
           ...
           public CodeReferenceRequest read(JsonReader in) throws IOException {
             ...
             CodeReferenceRequest instance = thisAdapter.fromJsonTree(jsonObj);
