...
public class CodeReferenceRequest {
    ...
    /**
     * The source control repository that contains the scanned code. (Source of the repository
     * selector on the ConfigCat Dashboard)
     *
     * @return repository
     */
    @javax.annotation.Nonnull
    ...
    /**
     * The currently active branches of the repository. Each previously uploaded report that belongs
     * to a non-reported active branch is being deleted.
     *
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.configId, codeReferenceRequest.configId)
                ...
                && Objects.equals(this.activeBranches, codeReferenceRequest.activeBranches)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CodeReferenceRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CodeReferenceRequest is not found in"
                                        + " the empty JSON string",
                                CodeReferenceRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `CodeReferenceRequest` properties. JSON: %s",
        ...
        if (jsonObj.get("activeBranches") != null
                && !jsonObj.get("activeBranches").isJsonNull()
                && !jsonObj.get("activeBranches").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `activeBranches` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("activeBranches").toString()));
        }
        if (jsonObj.get("flagReferences") != null && !jsonObj.get("flagReferences").isJsonNull()) {
            ...
            if (jsonArrayflagReferences != null) {
                ...
                if (!jsonObj.get("flagReferences").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `flagReferences` to be an array in the"
                                            + " JSON string but got `%s`",
                                    jsonObj.get("flagReferences").toString()));
                }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CodeReferenceRequest>() {
                        @Override
                        public void write(JsonWriter out, CodeReferenceRequest value)
                                throws IOException {
