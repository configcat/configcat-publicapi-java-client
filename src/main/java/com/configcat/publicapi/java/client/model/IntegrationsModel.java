...
public class IntegrationsModel {
   ...
   * @return the IntegrationsModel instance itself
   */
  public IntegrationsModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IntegrationsModel>() {
           ...
           public IntegrationsModel read(JsonReader in) throws IOException {
             ...
             IntegrationsModel instance = thisAdapter.fromJsonTree(jsonObj);
