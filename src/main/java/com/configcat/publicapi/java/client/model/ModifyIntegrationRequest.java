...
public class ModifyIntegrationRequest {
   ...
   * @return the ModifyIntegrationRequest instance itself
   */
  public ModifyIntegrationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, modifyIntegrationRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, modifyIntegrationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, parameters, environmentIds, configIds, additionalProperties);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModifyIntegrationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModifyIntegrationRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ModifyIntegrationRequest>() {
           @Override
           public void write(JsonWriter out, ModifyIntegrationRequest value) throws IOException {
           ...
           public ModifyIntegrationRequest read(JsonReader in) throws IOException {
             ...
             ModifyIntegrationRequest instance = thisAdapter.fromJsonTree(jsonObj);
