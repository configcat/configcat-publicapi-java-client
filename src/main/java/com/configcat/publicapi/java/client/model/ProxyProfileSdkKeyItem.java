...
public class ProxyProfileSdkKeyItem {
  ...
  public String getPrimarySdkKey() {
    return primarySdkKey;
  }
  ...
  public String getSecondarySdkKey() {
    return secondarySdkKey;
  }
   ...
   * @return the ProxyProfileSdkKeyItem instance itself
   */
  public ProxyProfileSdkKeyItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProxyProfileSdkKeyItem proxyProfileSdkKeyItem = (ProxyProfileSdkKeyItem) o;
    return Objects.equals(this.primarySdkKey, proxyProfileSdkKeyItem.primarySdkKey) &&
        Objects.equals(this.secondarySdkKey, proxyProfileSdkKeyItem.secondarySdkKey) &&
        Objects.equals(this.sdkId, proxyProfileSdkKeyItem.sdkId) &&
        Objects.equals(this.configId, proxyProfileSdkKeyItem.configId) &&
        Objects.equals(this.environmentId, proxyProfileSdkKeyItem.environmentId)&&
        Objects.equals(this.additionalProperties, proxyProfileSdkKeyItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(primarySdkKey, secondarySdkKey, sdkId, configId, environmentId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProxyProfileSdkKeyItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProxyProfileSdkKeyItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyProfileSdkKeyItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyProfileSdkKeyItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyProfileSdkKeyItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyProfileSdkKeyItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyProfileSdkKeyItem>() {
           @Override
           public void write(JsonWriter out, ProxyProfileSdkKeyItem value) throws IOException {
           ...
           @Override
           public ProxyProfileSdkKeyItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ProxyProfileSdkKeyItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ProxyProfileSdkKeyItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProxyProfileSdkKeyItem
   * @throws IOException if the JSON string is invalid with respect to ProxyProfileSdkKeyItem
   */
  public static ProxyProfileSdkKeyItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyProfileSdkKeyItem.class);
  }

  /**
   * Convert an instance of ProxyProfileSdkKeyItem to an JSON string
   *
   * @return JSON string
   */
