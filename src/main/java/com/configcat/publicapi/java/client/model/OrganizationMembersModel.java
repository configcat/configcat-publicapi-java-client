...
import com.configcat.publicapi.java.client.model.OrganizationAdminModel;
import com.configcat.publicapi.java.client.model.OrganizationMemberModel;
...
public class OrganizationMembersModel {
  ...
  public OrganizationMembersModel addBillingManagersItem(OrganizationAdminModel billingManagersItem) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationMembersModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationMembersModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationMembersModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationMembersModel' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrganizationMembersModel>() {
           @Override
           public void write(JsonWriter out, OrganizationMembersModel value) throws IOException {
