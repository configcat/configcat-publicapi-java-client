...
public class OrganizationMembersModel {
   ...
   * @return the OrganizationMembersModel instance itself
   */
  public OrganizationMembersModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrganizationMembersModel>() {
           ...
           public OrganizationMembersModel read(JsonReader in) throws IOException {
             ...
             OrganizationMembersModel instance = thisAdapter.fromJsonTree(jsonObj);
