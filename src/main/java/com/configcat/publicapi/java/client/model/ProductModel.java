...
public class ProductModel {
   ...
   * @return the ProductModel instance itself
   */
  public ProductModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductModel>() {
           ...
           public ProductModel read(JsonReader in) throws IOException {
             ...
             ProductModel instance = thisAdapter.fromJsonTree(jsonObj);
