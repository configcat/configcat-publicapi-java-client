...
public class ProductModel {
    ...
    /**
     * The order of the Product represented on the ConfigCat Dashboard. Determined from an ascending
     ...
     * Settings within a Product are saved.
     *
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.organization, productModel.organization)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(organization, productId, name, description, order, reasonRequired);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ProductModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ProductModel is not found in the"
                                        + " empty JSON string",
                                ProductModel.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ProductModel` properties. JSON: %s",
