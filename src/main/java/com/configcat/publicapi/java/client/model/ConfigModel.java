...
public class ConfigModel {
    ...
    public int hashCode() {
        return Objects.hash(
                product, configId, name, description, order, migratedConfigId, evaluationVersion);
    }
    ...
    public String toString() {
        ...
        sb.append("    evaluationVersion: ")
                .append(toIndentedString(evaluationVersion))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ConfigModel.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ConfigModel is not found in the empty"
                                        + " JSON string",
                                ConfigModel.openapiRequiredFields.toString()));
            }
        }
        ...
        if ((jsonObj.get("migratedConfigId") != null
                        && !jsonObj.get("migratedConfigId").isJsonNull())
                && !jsonObj.get("migratedConfigId").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `migratedConfigId` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("migratedConfigId").toString()));
        }
        // validate the optional field `evaluationVersion`
        if (jsonObj.get("evaluationVersion") != null
                && !jsonObj.get("evaluationVersion").isJsonNull()) {
