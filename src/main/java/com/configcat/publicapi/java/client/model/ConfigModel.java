...
public class ConfigModel {
   ...
   * @return the ConfigModel instance itself
   */
  public ConfigModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConfigModel>() {
           ...
           public ConfigModel read(JsonReader in) throws IOException {
             ...
             ConfigModel instance = thisAdapter.fromJsonTree(jsonObj);
