...
import com.configcat.publicapi.java.client.model.SdkKeysModel;
...
public class SdkKeysApi {
     ...
     * </table>
     */
    public okhttp3.Call getSdkKeysCall(
    ...
    private okhttp3.Call getSdkKeysValidateBeforeCall(
            UUID configId, UUID environmentId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'configId' is set
        if (configId == null) {
            throw new ApiException(
                    "Missing the required parameter 'configId' when calling getSdkKeys(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<SdkKeysModel> getSdkKeysWithHttpInfo(UUID configId, UUID environmentId)
            throws ApiException {
    ...
    /**
     * Get SDK Key (asynchronously) This endpoint returns the SDK Key for your Config in a specified
     * Environment.
     *
     * @param configId The identifier of the Config. (required)
     * @param environmentId The identifier of the Environment. (required)
     ...
     * </table>
     */
    public okhttp3.Call getSdkKeysAsync(
            UUID configId, UUID environmentId, final ApiCallback<SdkKeysModel> _callback)
            throws ApiException {

        okhttp3.Call localVarCall =
                getSdkKeysValidateBeforeCall(configId, environmentId, _callback);
        Type localVarReturnType = new TypeToken<SdkKeysModel>() {}.getType();
