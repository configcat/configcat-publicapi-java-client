...
public class IntegrationLinkModel {
   ...
   * @return the IntegrationLinkModel instance itself
   */
  public IntegrationLinkModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IntegrationLinkModel>() {
           ...
           public IntegrationLinkModel read(JsonReader in) throws IOException {
             ...
             IntegrationLinkModel instance = thisAdapter.fromJsonTree(jsonObj);
