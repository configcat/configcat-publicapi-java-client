...
import com.configcat.publicapi.java.client.model.UpdatePredefinedVariationValueModel;
...
public class UpdatePredefinedVariationModel {
  ...
  public UpdatePredefinedVariationValueModel getValue() {
    return value;
  }
   ...
   * @return the UpdatePredefinedVariationModel instance itself
   */
  public UpdatePredefinedVariationModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePredefinedVariationModel updatePredefinedVariationModel = (UpdatePredefinedVariationModel) o;
    return Objects.equals(this.value, updatePredefinedVariationModel.value) &&
        Objects.equals(this.name, updatePredefinedVariationModel.name) &&
        Objects.equals(this.hint, updatePredefinedVariationModel.hint) &&
        Objects.equals(this.predefinedVariationId, updatePredefinedVariationModel.predefinedVariationId)&&
        Objects.equals(this.additionalProperties, updatePredefinedVariationModel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePredefinedVariationModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePredefinedVariationModel
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePredefinedVariationModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePredefinedVariationModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePredefinedVariationModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePredefinedVariationModel.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePredefinedVariationModel>() {
           @Override
           public void write(JsonWriter out, UpdatePredefinedVariationModel value) throws IOException {
           ...
           @Override
           public UpdatePredefinedVariationModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdatePredefinedVariationModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpdatePredefinedVariationModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePredefinedVariationModel
   * @throws IOException if the JSON string is invalid with respect to UpdatePredefinedVariationModel
   */
  public static UpdatePredefinedVariationModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePredefinedVariationModel.class);
  }

  /**
   * Convert an instance of UpdatePredefinedVariationModel to an JSON string
   *
   * @return JSON string
   */
