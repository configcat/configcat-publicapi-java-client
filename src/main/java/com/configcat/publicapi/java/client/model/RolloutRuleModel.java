...
public class RolloutRuleModel {
   ...
   */
  @JsonAdapter(SegmentComparatorEnum.Adapter.class)
  public enum SegmentComparatorEnum {
    ...
    SegmentComparatorEnum(String value) {
      this.value = value;
    }
    ...
    public static SegmentComparatorEnum fromValue(String value) {
      for (SegmentComparatorEnum b : SegmentComparatorEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<SegmentComparatorEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SegmentComparatorEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SegmentComparatorEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SegmentComparatorEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      SegmentComparatorEnum.fromValue(value);
    }
  }
  ...
  private SegmentComparatorEnum segmentComparator;
  ...
  public RolloutRuleModel comparator(ComparatorEnum comparator) {
  ...
  public RolloutRuleModel segmentComparator(SegmentComparatorEnum segmentComparator) {
   ...
   */
  @javax.annotation.Nullable
  public SegmentComparatorEnum getSegmentComparator() {
    return segmentComparator;
  }

  public void setSegmentComparator(SegmentComparatorEnum segmentComparator) {
    this.segmentComparator = segmentComparator;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comparisonAttribute, comparator, comparisonValue, value, segmentComparator, segmentId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("segmentComparator") != null && !jsonObj.get("segmentComparator").isJsonNull()) && !jsonObj.get("segmentComparator").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `segmentComparator` to be a primitive type in the JSON string but got `%s`", jsonObj.get("segmentComparator").toString()));
      }
      ...
      if (jsonObj.get("segmentComparator") != null && !jsonObj.get("segmentComparator").isJsonNull()) {
        SegmentComparatorEnum.validateJsonElement(jsonObj.get("segmentComparator"));
      }
