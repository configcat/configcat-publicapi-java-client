...
public class RolloutRuleModel {
   ...
   * @return the RolloutRuleModel instance itself
   */
  public RolloutRuleModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RolloutRuleModel>() {
           ...
           public RolloutRuleModel read(JsonReader in) throws IOException {
             ...
             RolloutRuleModel instance = thisAdapter.fromJsonTree(jsonObj);
