...
public class AuditLogsApi {
     ...
     */
    public okhttp3.Call getAuditlogsCall(UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAuditlogsValidateBeforeCall(UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime, final ApiCallback _callback) throws ApiException {
     ...
     */
    public List<AuditLogItemModel> getAuditlogs(UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime) throws ApiException {
     ...
     */
    public ApiResponse<List<AuditLogItemModel>> getAuditlogsWithHttpInfo(UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime) throws ApiException {
     ...
     */
    public okhttp3.Call getAuditlogsAsync(UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime, final ApiCallback<List<AuditLogItemModel>> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getOrganizationAuditlogsCall(UUID organizationId, UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrganizationAuditlogsValidateBeforeCall(UUID organizationId, UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime, final ApiCallback _callback) throws ApiException {
     ...
     */
    public List<AuditLogItemModel> getOrganizationAuditlogs(UUID organizationId, UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime) throws ApiException {
     ...
     */
    public ApiResponse<List<AuditLogItemModel>> getOrganizationAuditlogsWithHttpInfo(UUID organizationId, UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime) throws ApiException {
     ...
     */
    public okhttp3.Call getOrganizationAuditlogsAsync(UUID organizationId, UUID productId, UUID configId, UUID environmentId, String auditLogType, OffsetDateTime fromUtcDateTime, OffsetDateTime toUtcDateTime, final ApiCallback<List<AuditLogItemModel>> _callback) throws ApiException {
