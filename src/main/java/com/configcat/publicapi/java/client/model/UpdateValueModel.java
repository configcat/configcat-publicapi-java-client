...
public class UpdateValueModel {
   ...
   * @return the UpdateValueModel instance itself
   */
  public UpdateValueModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateValueModel updateValueModel = (UpdateValueModel) o;
    return Objects.equals(this.boolValue, updateValueModel.boolValue) &&
        Objects.equals(this.stringValue, updateValueModel.stringValue) &&
        Objects.equals(this.intValue, updateValueModel.intValue) &&
        Objects.equals(this.doubleValue, updateValueModel.doubleValue) &&
        Objects.equals(this.predefinedVariationId, updateValueModel.predefinedVariationId)&&
        Objects.equals(this.additionalProperties, updateValueModel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateValueModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateValueModel
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateValueModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateValueModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateValueModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateValueModel.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateValueModel>() {
           @Override
           public void write(JsonWriter out, UpdateValueModel value) throws IOException {
           ...
           @Override
           public UpdateValueModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateValueModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpdateValueModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateValueModel
   * @throws IOException if the JSON string is invalid with respect to UpdateValueModel
   */
  public static UpdateValueModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateValueModel.class);
  }

  /**
   * Convert an instance of UpdateValueModel to an JSON string
   *
   * @return JSON string
   */
