...
import com.configcat.publicapi.java.client.model.WebhookNotification;
...
public class ConnectionPreferences {
   ...
   * @return the ConnectionPreferences instance itself
   */
  public ConnectionPreferences putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sdkPollInterval, connectionPreferences.sdkPollInterval) &&
        Objects.equals(this.webhookNotification, connectionPreferences.webhookNotification)&&
        Objects.equals(this.additionalProperties, connectionPreferences.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectionPreferences
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionPreferences>() {
           @Override
           public void write(JsonWriter out, ConnectionPreferences value) throws IOException {
           ...
           @Override
           public ConnectionPreferences read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ConnectionPreferences instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ConnectionPreferences given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectionPreferences
   * @throws IOException if the JSON string is invalid with respect to ConnectionPreferences
   */
  public static ConnectionPreferences fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionPreferences.class);
  }

  /**
   * Convert an instance of ConnectionPreferences to an JSON string
   *
   * @return JSON string
   */
