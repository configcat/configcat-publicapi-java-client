...
public class ReplaceSettingModel {
   ...
   * @return the ReplaceSettingModel instance itself
   */
  public ReplaceSettingModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReplaceSettingModel>() {
           ...
           public ReplaceSettingModel read(JsonReader in) throws IOException {
             ...
             ReplaceSettingModel instance = thisAdapter.fromJsonTree(jsonObj);
