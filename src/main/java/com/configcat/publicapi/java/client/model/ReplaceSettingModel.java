...
public class ReplaceSettingModel {
  ...
  public ReplaceSettingModel addTagsItem(Long tagsItem) {
    if (this.tags == null) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hint, tags, order, name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplaceSettingModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplaceSettingModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplaceSettingModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplaceSettingModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplaceSettingModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplaceSettingModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplaceSettingModel.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplaceSettingModel>() {
           @Override
           public void write(JsonWriter out, ReplaceSettingModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplaceSettingModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplaceSettingModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplaceSettingModel
   * @throws IOException if the JSON string is invalid with respect to ReplaceSettingModel
   */
  public static ReplaceSettingModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplaceSettingModel.class);
  }

  /**
   * Convert an instance of ReplaceSettingModel to an JSON string
   *
   * @return JSON string
   */
