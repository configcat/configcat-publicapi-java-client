...
public class UpdateMemberPermissionsRequest {
    ...
    public static final String SERIALIZED_NAME_REMOVE_FROM_PERMISSION_GROUPS_WHERE_ID_NOT_SET =
    ...
    public UpdateMemberPermissionsRequest removeFromPermissionGroupsWhereIdNotSet(
            Boolean removeFromPermissionGroupsWhereIdNotSet) {
        this.removeFromPermissionGroupsWhereIdNotSet = removeFromPermissionGroupsWhereIdNotSet;
        return this;
    }

    /**
     * When &#x60;true&#x60;, the member will be removed from those Permission Groups that are not
     * listed in the &#x60;permissionGroupIds&#x60; field.
     *
    ...
    public void setRemoveFromPermissionGroupsWhereIdNotSet(
            Boolean removeFromPermissionGroupsWhereIdNotSet) {
        this.removeFromPermissionGroupsWhereIdNotSet = removeFromPermissionGroupsWhereIdNotSet;
    }
    ...
    public boolean equals(Object o) {
        ...
        UpdateMemberPermissionsRequest updateMemberPermissionsRequest =
                (UpdateMemberPermissionsRequest) o;
        return Objects.equals(
                        this.permissionGroupIds, updateMemberPermissionsRequest.permissionGroupIds)
                && Objects.equals(this.isAdmin, updateMemberPermissionsRequest.isAdmin)
                && Objects.equals(
                        this.isBillingManager, updateMemberPermissionsRequest.isBillingManager)
                && Objects.equals(
                        this.removeFromPermissionGroupsWhereIdNotSet,
    ...
    public String toString() {
        ...
        sb.append("    permissionGroupIds: ")
                .append(toIndentedString(permissionGroupIds))
                .append("\n");
        sb.append("    isAdmin: ").append(toIndentedString(isAdmin)).append("\n");
        sb.append("    isBillingManager: ").append(toIndentedString(isBillingManager)).append("\n");
        sb.append("    removeFromPermissionGroupsWhereIdNotSet: ")
                .append(toIndentedString(removeFromPermissionGroupsWhereIdNotSet))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateMemberPermissionsRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateMemberPermissionsRequest is not"
                                        + " found in the empty JSON string",
                                UpdateMemberPermissionsRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `UpdateMemberPermissionsRequest` properties. JSON: %s",
        ...
        if (jsonObj.get("permissionGroupIds") != null
                && !jsonObj.get("permissionGroupIds").isJsonNull()
                && !jsonObj.get("permissionGroupIds").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `permissionGroupIds` to be an array in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("permissionGroupIds").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateMemberPermissionsRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateMemberPermissionsRequest' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<UpdateMemberPermissionsRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(UpdateMemberPermissionsRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateMemberPermissionsRequest>() {
                        @Override
                        public void write(JsonWriter out, UpdateMemberPermissionsRequest value)
                                throws IOException {
                        ...
                        @Override
                        public UpdateMemberPermissionsRequest read(JsonReader in)
                                throws IOException {
