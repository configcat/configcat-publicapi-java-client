...
public class PrerequisiteFlagConditionModel {
  ...
  public PrerequisiteFlagConditionModel prerequisiteComparisonValue(ValueModel prerequisiteComparisonValue) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrerequisiteFlagConditionModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrerequisiteFlagConditionModel is not found in the empty JSON string", PrerequisiteFlagConditionModel.openapiRequiredFields.toString()));
        }
      }
