...
public class PrerequisiteFlagConditionModel {
  ...
  public PrerequisiteFlagConditionModel prerequisiteSettingId(@javax.annotation.Nonnull Integer prerequisiteSettingId) {
  ...
  public PrerequisiteFlagConditionModel comparator(@javax.annotation.Nonnull PrerequisiteComparator comparator) {
  ...
  public PrerequisiteFlagConditionModel prerequisiteComparisonValue(@javax.annotation.Nonnull ValueModel prerequisiteComparisonValue) {
  ...
  public void setPrerequisiteComparisonValue(@javax.annotation.Nonnull ValueModel prerequisiteComparisonValue) {
    this.prerequisiteComparisonValue = prerequisiteComparisonValue;
  }
   ...
   * @return the PrerequisiteFlagConditionModel instance itself
   */
  public PrerequisiteFlagConditionModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrerequisiteFlagConditionModel prerequisiteFlagConditionModel = (PrerequisiteFlagConditionModel) o;
    return Objects.equals(this.prerequisiteSettingId, prerequisiteFlagConditionModel.prerequisiteSettingId) &&
        Objects.equals(this.comparator, prerequisiteFlagConditionModel.comparator) &&
        Objects.equals(this.prerequisiteComparisonValue, prerequisiteFlagConditionModel.prerequisiteComparisonValue)&&
        Objects.equals(this.additionalProperties, prerequisiteFlagConditionModel.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrerequisiteFlagConditionModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrerequisiteFlagConditionModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PrerequisiteFlagConditionModel is not found in the empty JSON string", PrerequisiteFlagConditionModel.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrerequisiteFlagConditionModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrerequisiteFlagConditionModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrerequisiteFlagConditionModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrerequisiteFlagConditionModel.class));

       return (TypeAdapter<T>) new TypeAdapter<PrerequisiteFlagConditionModel>() {
           @Override
           public void write(JsonWriter out, PrerequisiteFlagConditionModel value) throws IOException {
           ...
           @Override
           public PrerequisiteFlagConditionModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PrerequisiteFlagConditionModel instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to PrerequisiteFlagConditionModel
   */
