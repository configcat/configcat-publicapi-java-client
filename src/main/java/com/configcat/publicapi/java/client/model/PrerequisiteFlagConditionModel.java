...
public class PrerequisiteFlagConditionModel {
  ...
  public PrerequisiteFlagConditionModel comparator(ComparatorEnum comparator) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrerequisiteFlagConditionModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrerequisiteFlagConditionModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
