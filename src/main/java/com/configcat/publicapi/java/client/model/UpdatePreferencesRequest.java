...
public class UpdatePreferencesRequest {
    ...
    public UpdatePreferencesRequest reasonRequiredEnvironments(
            List<UpdateReasonRequiredEnvironmentModel> reasonRequiredEnvironments) {
        this.reasonRequiredEnvironments = reasonRequiredEnvironments;
        return this;
    }

    public UpdatePreferencesRequest addReasonRequiredEnvironmentsItem(
            UpdateReasonRequiredEnvironmentModel reasonRequiredEnvironmentsItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.reasonRequired, updatePreferencesRequest.reasonRequired)
                && Objects.equals(
                        this.keyGenerationMode, updatePreferencesRequest.keyGenerationMode)
                && Objects.equals(this.showVariationId, updatePreferencesRequest.showVariationId)
                && Objects.equals(
                        this.mandatorySettingHint, updatePreferencesRequest.mandatorySettingHint)
                && Objects.equals(
                        this.reasonRequiredEnvironments,
                        updatePreferencesRequest.reasonRequiredEnvironments);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdatePreferencesRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdatePreferencesRequest is not found"
                                        + " in the empty JSON string",
                                UpdatePreferencesRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `UpdatePreferencesRequest` properties. JSON: %s",
        ...
        if (jsonObj.get("reasonRequiredEnvironments") != null
            ...
            if (jsonArrayreasonRequiredEnvironments != null) {
                ...
                for (int i = 0; i < jsonArrayreasonRequiredEnvironments.size(); i++) {
                    UpdateReasonRequiredEnvironmentModel.validateJsonElement(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdatePreferencesRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdatePreferencesRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdatePreferencesRequest>() {
                        @Override
                        public void write(JsonWriter out, UpdatePreferencesRequest value)
                                throws IOException {
