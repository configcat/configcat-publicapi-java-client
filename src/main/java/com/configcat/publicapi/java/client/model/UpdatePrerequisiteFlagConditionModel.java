...
public class UpdatePrerequisiteFlagConditionModel {
   ...
   */
  @javax.annotation.Nonnull
  public UpdateValueModel getPrerequisiteComparisonValue() {
    return prerequisiteComparisonValue;
  }
   ...
   * @return the UpdatePrerequisiteFlagConditionModel instance itself
   */
  public UpdatePrerequisiteFlagConditionModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePrerequisiteFlagConditionModel updatePrerequisiteFlagConditionModel = (UpdatePrerequisiteFlagConditionModel) o;
    return Objects.equals(this.prerequisiteSettingId, updatePrerequisiteFlagConditionModel.prerequisiteSettingId) &&
        Objects.equals(this.comparator, updatePrerequisiteFlagConditionModel.comparator) &&
        Objects.equals(this.prerequisiteComparisonValue, updatePrerequisiteFlagConditionModel.prerequisiteComparisonValue)&&
        Objects.equals(this.additionalProperties, updatePrerequisiteFlagConditionModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(prerequisiteSettingId, comparator, prerequisiteComparisonValue, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePrerequisiteFlagConditionModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePrerequisiteFlagConditionModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      UpdateValueModel.validateJsonElement(jsonObj.get("prerequisiteComparisonValue"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePrerequisiteFlagConditionModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePrerequisiteFlagConditionModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePrerequisiteFlagConditionModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePrerequisiteFlagConditionModel.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePrerequisiteFlagConditionModel>() {
           @Override
           public void write(JsonWriter out, UpdatePrerequisiteFlagConditionModel value) throws IOException {
           ...
           @Override
           public UpdatePrerequisiteFlagConditionModel read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdatePrerequisiteFlagConditionModel instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpdatePrerequisiteFlagConditionModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePrerequisiteFlagConditionModel
   * @throws IOException if the JSON string is invalid with respect to UpdatePrerequisiteFlagConditionModel
   */
  public static UpdatePrerequisiteFlagConditionModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePrerequisiteFlagConditionModel.class);
  }

  /**
   * Convert an instance of UpdatePrerequisiteFlagConditionModel to an JSON string
   *
   * @return JSON string
   */
